...
class _AvatarSelectorWidgetState extends State<AvatarSelectorWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final displayNameLabel = widget.localizedStrings['profile']?['displayName'] ?? 'Display Name';
    final note = widget.localizedStrings['profile']?['note'] ??
        'This is your display name shown in-game. It’s independent of your login identity.';
